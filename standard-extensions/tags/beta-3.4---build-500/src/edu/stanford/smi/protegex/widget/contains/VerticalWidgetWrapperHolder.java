 ...
 */
public class VerticalWidgetWrapperHolder extends WidgetWrapperHolder {

    public VerticalWidgetWrapperHolder() {
        super(
    ...
    public VerticalWidgetWrapperHolder(int spacerSize, boolean useSpacers) {
    ...
    protected WidgetBox getWidgetBox(int spacerSize, boolean useSpacers) {
        return new WidgetBox(new VerticalWidgetBoxLayoutManager(), spacerSize, useSpacers);
    }
